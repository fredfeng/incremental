...
(define (solve-db-constraints cond-lst)
  (begin
    ...
    (define-symbolic width integer?)
    (define-symbolic ml integer?)
    (define-symbolic mr integer?)
    (define-symbolic left integer?)
    (define-symbolic right integer?)
    (define-symbolic static-x integer?)
    (define-symbolic shrink-to-fit integer?)
    (define-symbolic container-width integer?)
    (define-symbolic width-new integer?)
    (define-symbolic ml-new integer?)
    (define-symbolic mr-new integer?)
    (define-symbolic left-new integer?)
    (define-symbolic right-new integer?)
    (define-symbolic static-x-new integer?)
    (define-symbolic shrink-to-fit-new integer?)
    (define-symbolic container-width-new integer?)
    
    (define-symbolic height integer?)
    (define-symbolic mt integer?)
    (define-symbolic mb integer?)
    (define-symbolic top integer?)
    (define-symbolic bottom integer?)
    (define-symbolic static-y integer?)
    (define-symbolic intrins-height integer?)
    (define-symbolic container-height integer?)
    (define-symbolic height-new integer?)
    (define-symbolic mt-new integer?)
    (define-symbolic mb-new integer?)
    (define-symbolic top-new integer?)
    (define-symbolic bottom-new integer?)
    (define-symbolic static-y-new integer?)
    (define-symbolic intrins-height-new integer?)
    (define-symbolic container-height-new integer?)
